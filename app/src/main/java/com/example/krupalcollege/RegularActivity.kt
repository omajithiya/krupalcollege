...
class RegularActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        database = FirebaseDatabase.getInstance().getReference("Regular")
    ...
    override fun onResume() {
        super.onResume()
        database = FirebaseDatabase.getInstance().getReference("Regular")  // ✅ Reinitialize reference
    ...
    private fun fetchCakesFromFirebase() {
        database.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (cakeList.isEmpty()) {
                    Toast.makeText(this@RegularActivity, "No cakes found!", Toast.LENGTH_SHORT).show()
                }
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@RegularActivity, "Failed to load data", Toast.LENGTH_SHORT).show()
