...
class AnnivarsaryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_annivarsary)
        ...
        database = FirebaseDatabase.getInstance().getReference("Anniversary")
    ...
    override fun onResume() {
        super.onResume()
        database = FirebaseDatabase.getInstance().getReference("Anniversary")  // ✅ Reinitialize reference
    ...
    private fun fetchCakesFromFirebase() {
        database.addListenerForSingleValueEvent(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                if (cakeList.isEmpty()) {
                    Toast.makeText(this@AnnivarsaryActivity, "No cakes found!", Toast.LENGTH_SHORT).show()
                }
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@AnnivarsaryActivity, "Failed to load data", Toast.LENGTH_SHORT).show()
